...
const dbPath = path.join(__dirname, '..', '..', 'servers.json');
...
const servers = [
  ...
  },
  {
    ...
    stats: {
      githubStars: 654,
      downloads: 4230,
      lastUpdated: '2024-11-05T00:00:00.000Z',
    },
    installation: {
  ...
  },
  {
    ...
    stats: {
      githubStars: 789,
      downloads: 5670,
      lastUpdated: '2024-11-07T00:00:00.000Z',
    },
    installation: {
  ...
  },
  {
    ...
    stats: {
      githubStars: 445,
      downloads: 3210,
      lastUpdated: '2024-11-06T00:00:00.000Z',
    },
    installation: {
...
try {
  console.log('🗄️ Creating JSON database with MCP servers...');
  fs.writeFileSync(dbPath, JSON.stringify(servers, null, 2));
  console.log(`✅ Successfully created database with ${servers.length} MCP servers`);
