 ...
 */
export declare enum EcosystemProduct {
...
export declare enum UserJourneyStage {
    DISCOVERY = "discovery",
...
export declare enum EcosystemEventType {
...
export declare const defaultEcosystemDbConfig: EcosystemDatabaseConfig;
