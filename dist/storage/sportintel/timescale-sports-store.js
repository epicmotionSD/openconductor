...
exports.TimescaleSportsStore = void 0;
const pg_1 = require("pg");
class TimescaleSportsStore {
    pool;
    logger;
    eventBus;
    initialized = false;
     ...
     */
    async insertPredictions(predictions) {
        if (!this.initialized)
            await this.initialize();
        const client = await this.pool.connect();
        try {
    ...
    async queryPlayerStats(filters) {
        ...
        try {
            ...
            const params = [filters.startTime, filters.endTime];
            let paramIndex = 3;
            if (filters.playerId) {
     ...
     */
    async getPlayerAggregates(playerId, timeframe) {
        if (!this.initialized)
            await this.initialize();
        const client = await this.pool.connect();
        try {
    ...
    async createPlayerStatsHypertable(client) {
        await client.query(`
    ...
    async createGameStatesHypertable(client) {
        await client.query(`
    ...
    async createPredictionsHypertable(client) {
        await client.query(`
    ...
    async createOwnershipHypertable(client) {
        await client.query(`
    ...
    async createInjuriesHypertable(client) {
        await client.query(`
    ...
    async createWeatherHypertable(client) {
        await client.query(`
    ...
    async setupCompressionPolicies(client) {
    ...
    async setupRetentionPolicies(client) {
    ...
    async createContinuousAggregates(client) {
    ...
    async createOptimizedIndexes(client) {
    ...
    getMaterializedViewName(timeframe) {
        switch (timeframe) {
            case '1h':
            case '1d':
...
exports.TimescaleSportsStore = TimescaleSportsStore;
//# sourceMappingURL=timescale-sports-store.js.map