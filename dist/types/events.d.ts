 ...
 */
export type EventType = 'agent.registered' | 'agent.unregistered' | 'agent.started' | 'agent.stopped' | 'agent.error' | 'agent.heartbeat' | 'workflow.created' | 'workflow.started' | 'workflow.completed' | 'workflow.failed' | 'workflow.cancelled' | 'step.started' | 'step.completed' | 'step.failed' | 'system.alert' | 'system.maintenance' | 'system.initialized' | 'system.started' | 'system.stopping' | 'custom';
