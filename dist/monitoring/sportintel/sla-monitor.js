...
exports.SportIntelSLAMonitor = void 0;
...
class SportIntelSLAMonitor {
     ...
     */
    async checkAllSLAs() {
        const promises = Array.from(this.slaTargets.values()).map(sla => this.checkSLA(sla).catch(error => {
     ...
     * Resolve SLA breach
     */
    async resolveSLABreach(slaName, currentValue) {
     ...
     */
    async sendAlerts(breach, isEscalation = false) {
     ...
     * Send email alert
     */
    async sendEmailAlert(channel, breach, isEscalation) {
     ...
     * Send Slack alert
     */
    async sendSlackAlert(channel, breach, isEscalation) {
     ...
     */
    async sendPagerDutyAlert(channel, breach, isEscalation) {
        const axios = require('axios');
        const payload = {
     ...
     * Send webhook alert
     */
    async sendWebhookAlert(channel, breach, isEscalation) {
        const axios = require('axios');
        const payload = {
            event: 'sla_breach',
            breach,
     ...
     */
    async sendResolutionNotification(breach, resolution) {
     ...
     */
    isPerformanceMetric(metricName) {
...
exports.SportIntelSLAMonitor = SportIntelSLAMonitor;
exports.default = SportIntelSLAMonitor;
