...
exports.ConfigurationError = exports.PluginError = exports.ToolExecutionError = exports.WorkflowExecutionError = exports.AgentExecutionError = exports.PermissionError = exports.ConflictError = exports.NotFoundError = exports.ValidationError = exports.CustomAPIError = void 0;
exports.createErrorHandler = createErrorHandler;
exports.asyncHandler = asyncHandler;
/**
 * Create error handler middleware
 */
function createErrorHandler(logger, errorManager) {
    return (error, req, res, next) => {
        ...
        if (error.isOperational !== false) {
            const managedError = errorManager.createError(error.code || 'UNKNOWN_ERROR', error.message, 'api', determineSeverity(errorResponse.statusCode), {
                requestId,
                method: req.method,
                url: req.url,
                userId: req.user?.id,
 ...
 */
function handleError(error, logger, errorManager) {
...
class CustomAPIError extends Error {
    ...
    field;
    isOperational;
    constructor(statusCode, code, message, details, field) {
        super(message);
...
class AgentExecutionError extends CustomAPIError {
    constructor(message, details) {
...
class WorkflowExecutionError extends CustomAPIError {
    constructor(message, details) {
...
class ToolExecutionError extends CustomAPIError {
    constructor(message, details) {
...
class PluginError extends CustomAPIError {
    constructor(message, details) {
...
class ConfigurationError extends CustomAPIError {
    constructor(message, details) {
