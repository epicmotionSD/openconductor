...
export function createLoggingMiddleware(logger: Logger) {
  return (req: Request, res: Response, next: NextFunction) => {
    ...
    function captureResponse(body: any) {
 ...
 */
export function createSecurityLogMiddleware(logger: Logger) {
  return (req: Request, res: Response, next: NextFunction) => {
 ...
 */
export function createAuditLogMiddleware(logger: Logger) {
  return (req: Request, res: Response, next: NextFunction) => {
    ...
    const operation = sensitiveOperations.find(op => 
      req.method === op.method && req.path.includes(op.path)
    );
